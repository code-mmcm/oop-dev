  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <footer 
        ...
        data-section="footer"
        className={`bg-gray-900 text-white py-8 sm:py-12 md:py-16 transition-all duration-1000 ease-out ${
          isVisible['footer'] 
            ? 'opacity-100 translate-y-0' 
            : 'opacity-0 translate-y-8'
        }`}
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="border-t border-gray-800 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm sm:text-base">© Copyright Traveler 2022</p>
