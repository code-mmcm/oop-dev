        ...
        <div className="max-w-2xl mx-auto mb-16">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300"
              style={{
                fontFamily: 'Poppins',
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#D4E9DC' }}>
                  <QuestionIcon />
                </div>
                <h2 
              ...
              <div className="space-y-3">
                {faqItems.map((item, index) => (
                  <div key={index} className="border-b border-gray-200 last:border-b-0 pb-3 last:pb-0">
                    ...
                    {expandedFAQ === index && (
                      <div 
                        className="mt-2 text-gray-600 pl-0"
                        style={{ fontFamily: 'Poppins' }}
                      >
                        {item.answer}
                      </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-white flex-shrink-0" style={{ backgroundColor: '#0B5858' }}>
              ...
              <form onSubmit={handleSubmitTicket} className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300"
                    style={{
                      fontFamily: 'Poppins',
                      '--tw-ring-color': '#549F74',
                    } as React.CSSProperties}
                ...
                <div>
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 resize-y"
                    style={{
                      fontFamily: 'Poppins',
                      '--tw-ring-color': '#549F74',
                    } as React.CSSProperties}
