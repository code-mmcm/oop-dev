...
/**
 * RightColumn component - Booking sidebar listings grid with skeleton loading
 * JSDoc: Displays booking sidebar listings in the original grid layout with loading and empty states
 */
