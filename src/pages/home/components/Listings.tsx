...
/**
 * Listings component - Original property listings grid with skeleton loading
 * JSDoc: Displays property listings in the original grid layout with loading and empty states
 */
