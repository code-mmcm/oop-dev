...
const ResultsSection: React.FC<ResultsSectionProps> = ({
  ...
  return (
    <div className="bg-white py-1 -mt-48 sm:-mt-52 md:-mt-56 animate-fade-in" style={{animationDelay: '0.8s', animationDuration: '400ms'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-6 md:pt-4">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 gap-4 sm:gap-0">
          <h2 
            ...
            style={{fontFamily: 'Poppins', fontWeight: 700, animationDelay: '1.0s', animationDuration: '400ms'}}
          >
            All listings
          </h2>
          
          {/* Recently added dropdown */}
          <div className="relative animate-fade-in-right self-start sm:self-auto" style={{animationDelay: '1.2s', animationDuration: '400ms'}}>
            <select
              value={sortBy}
              onChange={(e) => {
