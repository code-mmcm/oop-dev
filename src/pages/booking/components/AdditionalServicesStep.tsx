...
const AdditionalServicesStep: React.FC<AdditionalServicesStepProps> = ({
  ...
  useEffect(() => {
    if (showServicesModal) {
      // small timeout so elements have rendered
  ...
  // Placeholder for step validation; currently true so Next remains enabled.
  // You can change this to implement step-specific validation.
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 pb-16 md:pb-6 text-xs sm:text-sm md:text-base">
      ...
      {/* Mobile fixed footer: Back + Next (visible on small screens) */}
      <div
        ...
        >
          ...
          >
            ...
            {/* catalog list: this is the scrollable area; modalInnerRef attached here
                ...
                - allow it to grow/shrink and scroll within available modal height
            */}
            <div
              ref={modalInnerRef}
              ...
              style={{
                ...
                // ensure scroll area doesn't exceed container on large screens and uses available height on small screens
