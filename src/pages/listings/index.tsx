            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl p-6 border border-gray-200 sticky top-[64px] z-40" style={{overflow: 'visible'}}>
              <div className="flex items-center justify-between mb-6">
                ...
                {hasActiveFilters() && (
                  <button
                    ...
                    className="px-3 py-1.5 text-xs text-[#0B5858] hover:text-[#094747] transition-colors font-medium flex items-center gap-2"
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0B5858] focus:border-transparent outline-none transition-all text-sm"
                  style={{fontFamily: 'Poppins'}}
                />
              </div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0B5858] focus:border-transparent outline-none cursor-pointer transition-all bg-white text-sm"
                  style={{fontFamily: 'Poppins'}}
                />
                <svg 
              ...
              <div className="relative">
                ...
                >
                  <input
                    ...
                    className="w-4 h-4 text-[#0B5858] border-gray-300 rounded focus:ring-[#0B5858] focus:ring-2"
                  />
                  <span className="text-sm text-gray-700 group-hover:text-gray-900" style={{fontFamily: 'Poppins', fontWeight: 500}}>
                ...
                <div className="relative dropdown-container">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0B5858] focus:border-transparent outline-none cursor-pointer transition-all text-sm"
                      style={{fontFamily: 'Poppins'}}
                    />
                    <svg 
                    ...
                    {isPriceDropdownOpen && (
                      <div className="absolute z-[9999] w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg p-4">
                        <div className="space-y-3">
                          <div>
                            <label className="block text-xs text-gray-600 mb-1" style={{fontFamily: 'Poppins'}}>Min Price</label>
                            <input
                              type="range"
                              min="0"
                              max="5000"
                              ...
                              className="w-full"
                            />
                            <div className="text-xs text-gray-700 mt-1" style={{fontFamily: 'Poppins'}}>${priceRange.min}</div>
                          </div>
                          <div>
                            <label className="block text-xs text-gray-600 mb-1" style={{fontFamily: 'Poppins'}}>Max Price</label>
                            <input
                              type="range"
                              min="0"
                              max="10000"
                              ...
                              className="w-full"
                            />
                            <div className="text-xs text-gray-700 mt-1" style={{fontFamily: 'Poppins'}}>${priceRange.max}</div>
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <div className="relative dropdown-container">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      placeholder={`${bedroomsRange.min} - ${bedroomsRange.max}`}
                      readOnly
                    ...
                    {isBedroomsDropdownOpen && (
                      <div className="absolute z-[9999] w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg p-4">
                        <div className="space-y-3">
                          <div>
                            <label className="block text-xs text-gray-600 mb-1" style={{fontFamily: 'Poppins'}}>Min Bedrooms</label>
                            <input
                              type="range"
                              min="0"
                              max={bedroomsRange.max}
                              step="1"
                              value={bedroomsRange.min}
                              onChange={(e) => handleBedroomsRangeChange('min', parseInt(e.target.value))}
                              className="w-full"
                            />
                            <div className="text-xs text-gray-700 mt-1" style={{fontFamily: 'Poppins'}}>{bedroomsRange.min}</div>
                          </div>
                          <div>
                            <label className="block text-xs text-gray-600 mb-1" style={{fontFamily: 'Poppins'}}>Max Bedrooms</label>
                            <input
                              type="range"
                              min={bedroomsRange.min}
                              max="10"
                              step="1"
                              value={bedroomsRange.max}
                              onChange={(e) => handleBedroomsRangeChange('max', parseInt(e.target.value))}
                              className="w-full"
                            />
                            <div className="text-xs text-gray-700 mt-1" style={{fontFamily: 'Poppins'}}>{bedroomsRange.max}</div>
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <div className="relative dropdown-container">
                  ...
                  >
                    ...
                    {selectedAmenities.length > 0 && (
                      <span className="ml-2 text-xs text-[#0B5858]" style={{fontFamily: 'Poppins', fontWeight: 500}}>
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={selectedAmenities.length > 0 ? `${selectedAmenities.length} selected` : ''}
                      readOnly
                    ...
                    {isAmenitiesDropdownOpen && (
                      <div className="absolute z-[99999] w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-2xl p-3 max-h-80 overflow-auto">
                        {availableAmenities.map((amenity) => (
                          <label
                            key={amenity}
                            className="flex items-center space-x-2 px-2 py-2 hover:bg-gray-50 rounded cursor-pointer transition-colors"
                          >
                            <input
                              type="checkbox"
                              ...
                              className="w-4 h-4 text-[#0B5858] border-gray-300 rounded focus:ring-[#0B5858] focus:ring-2"
                            />
                            <span className="text-sm text-gray-700" style={{fontFamily: 'Poppins', fontWeight: 400}}>
                              {amenity}
                            </span>
                          </label>
                        ))}
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-4">
              ...
              <div className="relative flex items-center gap-2">
                ...
                <select
                  ...
                  className="appearance-none bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm cursor-pointer focus:outline-none focus:border-[#0B5858] transition-all hover:border-gray-400"
            ...
            {isLoading ? (
              ...
              <div className="mb-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-yellow-800" style={{fontFamily: 'Poppins'}}>{error}</p>
                </div>
              </div>
            ) : listings.length === 0 ? (
