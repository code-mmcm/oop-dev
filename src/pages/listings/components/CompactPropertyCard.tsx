...
/**
 * Compact Property Card for All Listings page
 * Smaller, more compact design for browsing many listings
 */
const CompactPropertyCard: React.FC<CompactPropertyCardProps> = ({ apartment, onApartmentClick }) => {
  return (
    ...
    >
      ...
      <div className="relative h-40 overflow-hidden">
        ...
        {apartment.is_featured && (
          <div className="absolute top-2 left-2">
            <span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium text-white bg-[#0B5858]" style={{fontFamily: 'Poppins'}}>
              Featured
            </span>
          </div>
        )}
      ...
      <div className="p-3">
        {/* Title */}
        <h3 className="text-sm font-semibold text-black mb-1.5 line-clamp-2 min-h-[2.5rem]" style={{fontFamily: 'Poppins', fontWeight: 600}}>
          {apartment.title}
        </h3>
        ...
        <div className="flex items-center mb-2">
          ...
          <p className="text-xs text-gray-600 truncate" style={{fontFamily: 'Poppins', fontWeight: 500}}>
            {apartment.location}
          </p>
        </div>
        ...
        <div className="flex items-baseline">
          <span className="text-base font-bold text-black" style={{fontFamily: 'Poppins', fontWeight: 700}}>
            {apartment.currency} {apartment.price?.toLocaleString()}
          </span>
          <span className="text-xs text-gray-500 ml-1" style={{fontFamily: 'Poppins', fontWeight: 500}}>
