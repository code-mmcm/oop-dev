    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-200">
      <div className="flex items-center justify-between px-4 sm:px-5 py-3 sm:py-4 border-b border-gray-100">
        ...
        <button 
          ...
          className="text-xs sm:text-sm px-3 py-1.5 rounded-md text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors" 
      ...
      <div className="divide-y divide-gray-100">
        {[1,2,3].map((i) => (
          <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 px-4 sm:px-5 py-4 hover:bg-gray-50 transition-colors">
            <div className="flex items-start sm:items-center gap-3 sm:gap-4">
              <img src="/avida.jpg" alt="listing" className="w-20 h-14 sm:w-24 sm:h-16 object-cover rounded-lg shadow-sm" />
              <div>
            ...
            <button 
              ...
              className="px-3 sm:px-4 py-2 rounded-md text-sm sm:text-base bg-gray-100 hover:bg-gray-200 w-full sm:w-auto transition-colors shadow-sm" 
              style={{ fontFamily: 'Poppins', fontWeight: 600 }}
            >
              View
            </button>
